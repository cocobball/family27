// /opt/family-dashboard/server/index.js
import dotenv from "dotenv";
import { existsSync } from "node:fs";
import { userInfo } from "node:os";

// Helpful crash logging in systemd/journalctl
...
async function main() {
  ...
  const { default: storage } = await import("./storage/index.js");
  ...
  // This is where the Express app + API routes usually get registered.
  await import("./app.js");
}
